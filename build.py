...
def build_pbo(temp_folder='', pbo_name='unnamed', use_color=False):
    ...
    subprocess.call('"C:/Users/Othello/OneDrive/Documents/CavStuff/ARMAKE/armake.exe" build -f -p "{}" "output/{}.pbo"'.format(os.path.join(temp_folder, "."),pbo_name), shell=True)
